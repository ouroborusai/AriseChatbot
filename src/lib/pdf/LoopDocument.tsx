...
/**
 *  ARISE DOCUMENT TEMPLATE v11.9.1 (Diamond Resilience)
...
export const LoopDocument = ({ reportType, companyName, date, data }: AriseDocumentProps) => {
    ...
    <Document title={`ARISE_Report_${reportType}`}>
      <Page size="A4" orientation={orientation} style={base.page}>
        ...
        <View style={base.footer}>
          <Text style={base.footerText}>Generado por Ouroborus AI · ARISE Business OS v11.9.1 Diamond Resilience</Text>
          <Text style={base.footerText}>Documento Certificado vía Supabase · Cloud Engine: Google Gemini 2.0 Flash</Text>
        </View>
