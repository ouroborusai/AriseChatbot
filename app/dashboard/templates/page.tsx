...
export default function TemplatesPage() {
  ...
  const categories = [
    ...
    { value: 'informacion', label: 'Información', color: 'bg-blue-600' },
      ...
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <div className="grid grid-cols-1 gap-4">
          {filteredTemplates.map((template) => (
            <div
              key={template.id}
              className="rounded-[32px] border border-slate-200 bg-white/95 p-6 shadow-sm"
            >
        ...
        <p className="text-sm text-slate-500 text-center">
          {filteredTemplates.length} plantilla{filteredTemplates.length !== 1 ? 's' : ''} disponible
