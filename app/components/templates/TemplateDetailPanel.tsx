...
export default function TemplateDetailPanel({
    ...
    return (
      <div className="card-base h-full">
        ...
        <div className="flex flex-col items-center justify-center h-[calc(100%-60px)] text-center">
          ...
          <p className="text-sm text-slate-500 font-medium">Selecciona un nodo</p>
          <p className="text-xs text-slate-400 mt-1">
            Haz clic en cualquier plantilla del flujo para ver sus detalles y conexiones
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="card-base h-full overflow-y-auto">
      <div className="flex items-center gap-2 mb-4">
        <div
