...
export default function ClientPortalPage({ params }: { params: { phone: string } }) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 flex items-center justify-center">
        <div className="text-white text-center p-8">
          ...
          <p className="text-slate-400">No encontramos un cliente asociado a este enlace.</p>
        </div>
      </div>
    );
  }
